...
public class MulticoreExecutor {
	...
	//Logger logger = Logger.getLogger("practical");//.addHandler(new FileHandler("connections.log"));//.setUseParentHandlers(true);
    ...
    private static void createThreadPool() {
        if (nprocs == -1) {
            ...
            try {
            	...
            	System.err.println("Failed to create multi-core execution thread pool: " + ex.getMessage());
            }
